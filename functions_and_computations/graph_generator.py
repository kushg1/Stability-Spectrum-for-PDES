...
for V in frange(0.5, 20.5, 0.5):
    for k in frange(1/np.sqrt(2.) + 0.04, 1., 0.01):
        ...
        plt.xlim([-2000, 2000])
        plt.ylim([-2000, 2000])
        plt.savefig(dir + '/img04V' + str(V) + 'k' + str(k) + '.png')
        plt.xlim([-200, 200])
        plt.ylim([-200, 200])
        plt.savefig(dir + '/img03V' + str(V) + 'k' + str(k) + '.png')
        plt.xlim([-20, 20])
        plt.ylim([-20, 20])
        plt.savefig(dir + '/img02V' + str(V) + 'k' + str(k) + '.png')
        plt.xlim([-10, 10])
        plt.ylim([-10, 10])
        plt.savefig(dir + '/img01V' + str(V) + 'k' + str(k) + '.png')
        plt.xlim([-5, 5])
        plt.ylim([-5, 5])
        plt.savefig(dir + '/img00V' + str(V) + 'k' + str(k) + '.png')

for V in frange(-20., 0., 0.5):
    for k in frange(0.02, 1./np.sqrt(2.) - 0.04, 0.01):
        mult_factor = np.sqrt(V / (2.*k ** 2. - 1.))
        ...
        plt.xlim([-2000, 2000])
        plt.ylim([-2000, 2000])
        plt.savefig(dir + '/img09V' + str(V) + 'k' + str(k) + '.png')
        plt.xlim([-200, 200])
        plt.ylim([-200, 200])
        plt.savefig(dir + '/img08V' + str(V) + 'k' + str(k) + '.png')
        plt.xlim([-20, 20])
        plt.ylim([-20, 20])
        plt.savefig(dir + '/img07V' + str(V) + 'k' + str(k) + '.png')
        plt.xlim([-10, 10])
        plt.ylim([-10, 10])
        plt.savefig(dir + '/img06V' + str(V) + 'k' + str(k) + '.png')
        plt.xlim([-5, 5])
        plt.ylim([-5, 5])
        plt.savefig(dir + '/img05V' + str(V) + 'k' + str(k) + '.png')

for V in frange(0.5, 20.5, 0.5):
    for k in frange(1.02, 2.02, 0.01):
        mult_factor = np.sqrt(V / (2. * k ** 2. - 1.))
        ...
        plt.xlim([-2000, 2000])
        plt.ylim([-2000, 2000])
        plt.savefig(dir + '/img14V' + str(V) + 'k' + str(k) + '.png')
        plt.xlim([-200, 200])
        plt.ylim([-200, 200])
        plt.savefig(dir + '/img13V' + str(V) + 'k' + str(k) + '.png')
        plt.xlim([-20, 20])
        plt.ylim([-20, 20])
        plt.savefig(dir + '/img12V' + str(V) + 'k' + str(k) + '.png')
        plt.xlim([-10, 10])
        plt.ylim([-10, 10])
        plt.savefig(dir + '/img11V' + str(V) + 'k' + str(k) + '.png')
        plt.xlim([-5, 5])
        plt.ylim([-5, 5])
        plt.savefig(dir + '/img10V' + str(V) + 'k' + str(k) + '.png')